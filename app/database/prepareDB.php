...
function seed_table_korisnici()
{
	...
	try
	{
		$st = $db->prepare( 'INSERT INTO splanner_korisnici(id_korisnici, OIB, username, ime, prezime, password_hash, email, tip_korisnika, spol, datum_rodenja, registration_sequence, fk_id_roditelja, prima_obavijest, has_registered) VALUES (:id_korisnici, :OIB, :username, :ime, :prezime, :password, \'a@b.com\', :tip, :spol, :datum_rodenja, :regseq, :fk_id_roditelja, True, :has )' );

		$st->execute( array( 'id_korisnici' => 1, 'OIB' => 12345678901, 'username' => 'mirko', 'ime' => "Mirko", 'prezime' => 'Trenerčević', 'password' => password_hash( 'mirkovasifra', PASSWORD_DEFAULT ), 'tip' => 'trener', 'spol' => 'muško', 'datum_rodenja' => '1990-07-07','regseq' => 'abc123', 'fk_id_roditelja' => NULL, 'has' => '1' ) );
		$st->execute( array( 'id_korisnici' => 3, 'OIB' => 12345678903, 'username' => 'ana', 'ime' => "Ana", 'prezime' => 'Trump', 'password' => password_hash( 'aninasifra', PASSWORD_DEFAULT ), 'tip' => 'roditelj', 'spol' => 'žensko', 'datum_rodenja' => '1982-01-05', 'regseq' => 'mhffhm78', 'fk_id_roditelja' => NULL, 'has' => '1' ) );
		$st->execute( array( 'id_korisnici' => 4, 'OIB' => 12345678904, 'username' => 'maja', 'ime' => "Maja", 'prezime' => 'Majić', 'password' => password_hash( 'majinasifra', PASSWORD_DEFAULT ), 'tip' => 'dijete', 'spol' => 'žensko', 'datum_rodenja' => '2017-06-20', 'regseq' => 'ilzkutj98', 'fk_id_roditelja' => 5, 'has' => '1' ) );
		$st->execute( array( 'id_korisnici' => 5, 'OIB' => 12345678905, 'username' => 'pero', 'ime' => "Pero", 'prezime' => 'Perić', 'password' => password_hash( 'perinasifra', PASSWORD_DEFAULT ), 'tip' => 'roditelj', 'spol' => 'muško', 'datum_rodenja' => '1991-05-15', 'regseq' => '21354sd', 'fk_id_roditelja' => NULL, 'has' => '1' ) );
		$st->execute( array( 'id_korisnici' => 6, 'OIB' => 12345678906, 'username' => 'hana', 'ime' => "Hana", 'prezime' => 'Hanić', 'password' => password_hash( 'haninasifra', PASSWORD_DEFAULT ), 'tip' => 'trener', 'spol' => 'žensko', 'datum_rodenja' => '1985-03-24', 'regseq' => '2gdr4sd', 'fk_id_roditelja' => NULL, 'has' => '1' ) );
		
		$st->execute( array( 'id_korisnici' => 2, 'OIB' => 12345678902, 'username' => 'slavko','ime' => "Slavko", 'prezime' => 'Trump',  'password' => password_hash( 'slavkovasifra', PASSWORD_DEFAULT ), 'tip' => 'dijete', 'spol' => 'muško', 'datum_rodenja' => '2010-10-07', 'regseq' => 'def456', 'fk_id_roditelja' => 3, 'has' => '1' ) );
		$st->execute( array( 'id_korisnici' => 7, 'OIB' => 12345678907, 'username' => 'ivica', 'ime' => "Ivica", 'prezime' => 'Trump', 'password' => password_hash( 'ivica', PASSWORD_DEFAULT ), 'tip' => 'dijete', 'spol' => 'muško', 'datum_rodenja' => '1982-01-05', 'regseq' => 'mhffhm78', 'fk_id_roditelja' => 3, 'has' => '1' ) );
		$st->execute( array( 'id_korisnici' => 8, 'OIB' => 12345678908, 'username' => 'marica','ime' => "Marica", 'prezime' => 'Trump',  'password' => password_hash( 'marica', PASSWORD_DEFAULT ), 'tip' => 'dijete', 'spol' => 'žensko', 'datum_rodenja' => '1982-01-05', 'regseq' => 'mhffhm78', 'fk_id_roditelja' => 3, 'has' => '1' ) );
	}
